...
function n_invc(ConsignID, AuctionID) {
    window.open("MVC/Site/Inventory#view=eventconsign&id=" + ConsignID + "&event=" + AuctionID, "_self");
}
function n_invel(LaneID) {
    window.open("MVC/Site/Inventory#view=lane&id=" + LaneID, "_self");
}
