...
(
   ...
   // megaavto
   9 => array(
      'domain' => 'http://a.mega-avto.com/USA/',
	  
	  'cookie_file' => Kohana::$cache_dir.'/megaauto/cookie.dat',
	  
      'remote_options' => array
	  (
         CURLOPT_COOKIEFILE => Kohana::$cache_dir.'/megaauto/cookie.dat',
         CURLOPT_COOKIEJAR => Kohana::$cache_dir.'/megaauto/cookie.dat',
	  ...
	  (
         ...
         'fields' => array(
            ...
            'searchOperation' => 'Search',
            'submittedQstr' => '',
            'vehicleTypes' => '4294967293',
			'odometers' => '4294967182',
            'saveRecentSearch' => 'true',
            'submittedQstr' => '',
            'newSort' => 'false',
            'searchOperation' => 'Search',
   ...
   */
   ...
   14 => array
   (
      'domain' => 'http://www.webautosalon.com/',

      'cookie_file' => Kohana::$cache_dir.'/web_auto_salon/cookie.dat',

      'remote_options' => array
      (
         CURLOPT_COOKIEFILE => Kohana::$cache_dir.'/web_auto_salon/cookie.dat',
         CURLOPT_COOKIEJAR => Kohana::$cache_dir.'/web_auto_salon/cookie.dat',
         CURLOPT_REFERER => 'http://www.webautosalon.com/manheim.php', // http://www.webautosalon.com/manheim.php?mode=search second request
      ),

      'search' => array
      (
         'items' => array(14002, 14003, 14004, 14005, 14006, 14007, 14008, 14009, 14010, 14011, 14012, 14013, 14014, 14017, 14019, 14020, 14022, 14023, 14024, 14025, 14026, 14027),
         'url' => 'http://www.webautosalon.com/manheim.php?mode=search',
         'offset' => 25,
         'fields' => array
         (
             'fromOdometer' => 'ALL',
             ...
             'mmrRanges' => 'ALL',
             'saleDate' => 'Дата продажи',
             'searchTerms' => 'Введите VIN или ключевое слово',
             'vehicleTypes' => '',
             'Search' => 'Поиск',
			 'srpResultsPerPage' => 25,
         ),
